...
//		String databaseFilePath = "cyclients/spIterator/Workspace/EmployeeDB.RAF"; 
		ArrayList<Byte[]> byteArrayList = new ArrayList<Byte[]>();				
		PSIterator  iterator = new PSIterator (Constants.databaseFilePath, catalogPath, expTreePath);
...
//			System.out.print("Record "+ recordCount +": "+ StringBytes.getString(Arrays.copyOfRange(temp, 0, 10))+","+StringBytes.getString(Arrays.copyOfRange(temp, 10, 20)));//EmployeeTuple.convertToEmployee(temp) + "");
	...
	public static void main(String [] args) throws SAXException, IOException, ParserConfigurationException{
		Demo.service("cyclients/psIterator/Workspace/catalog.xml", "cyclients/psIterator/Workspace/expTree.xml" , "Dept");
